...
Flex容器默认有两根轴：主轴（main axis）和侧轴（cross axis）。
...
![](https://cdn.jsdelivr.net/gh/K8963/cloudimg@master/CSS/justify-content.jpg)
...
![](https://cdn.jsdelivr.net/gh/K8963/cloudimg@master/CSS/align-items.png)

## align-content多根轴线侧轴上的对齐方式
...
![](https://cdn.jsdelivr.net/gh/K8963/cloudimg@master/CSS/align-content.png)
